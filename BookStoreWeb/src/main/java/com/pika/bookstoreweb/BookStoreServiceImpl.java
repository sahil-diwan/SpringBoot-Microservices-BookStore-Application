...
public class BookStoreServiceImpl implements BookStoreService{
	...
	public List<String> getCategoryList(){
		...
		String endpoint="http://localhost:5000/mybooks/"+author+"/"+category;
		...
		RestTemplate bookSearchRest=new RestTemplate();
		String endpoint="http://localhost:5000/mybook/"+bookId;
		...
		public Book getBookByBookId(Integer bookId) {
			...
			String priceEndpoint="http://localhost:8000/offeredPrice/"+bookId;
			...
			String orderEndpoint="http://localhost:6000/placeOrder";
			...
			public void addUserRating(UserRating userRating) {
				...
				String ratingEndpoint="http://localhost:7000/addUserRating";
				...
				String ratingEndpoint="http://localhost:7000/userRatings/"+userId;
				RestTemplate ratingRest=new RestTemplate();
